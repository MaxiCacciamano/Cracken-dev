...
export const Educacion = () => {
  ...
  <li class="timeline-event">
    ...
    <div class="timeline-event-copy">
      ...
      <p><strong><a href='./certificados' style={{cursor:'pointer'}}>certificados</a></strong><br/>Aprendiendo los fundamentos basicos y mas importantes de la programacion orientada a FrontEnd y  aplicarlos de forma profesional.<br/>
  ...
  <li class="timeline-event">
    ...
    <div class="timeline-event-copy">
      ...
      <p><strong><a href='/certificado-henry' style={{cursor:'pointer'}}>certificado</a></strong><br/>Aplicar concecptos de programación, nuevas tecnologias y trabajar de forma profesional, como programador Fullstack<br/>
